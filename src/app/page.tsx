    ...
    return (
        <main className="flex min-h-screen w-full flex-col items-center justify-center bg-secondary/10 p-4">
          <div className="flex flex-col items-center space-y-8 text-center">
            ...
            <Image src="https://i.postimg.cc/qM6DHxKn/emprende1.png" alt="EmprendeIA Logo" width={128} height={128} className="rounded-full border-4 border-primary/50 drop-shadow-[0_5px_15px_rgba(99,102,241,0.5)]" />
