  ...
  return (
    <main className="relative flex min-h-screen w-full flex-col items-center overflow-hidden p-4 py-10 sm:p-8">
        ...
        <Card className="relative z-10 w-full max-w-3xl overflow-hidden border bg-card shadow-aurora-lg">
            <div className="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 opacity-80" />
            <CardHeader className="space-y-3 pt-8 text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-fuchsia-500 text-white shadow-aurora">
                    <Sparkles className="h-7 w-7" />
                </div>
                <CardTitle className="font-headline text-2xl tracking-tight sm:text-3xl">Empecemos tu nuevo emprendimiento</CardTitle>
                <CardDescription className="text-base">Responde estas preguntas para que la IA entienda tu visión.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
